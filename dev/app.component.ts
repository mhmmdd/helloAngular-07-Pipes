...
@Component({
  ...
  template: `
    ...
    <section class="pipe">
      ...
      <input type="text" #inputSlicePipe (keyup)="0">
    ...
    <section class="pipe">
      ...
      <div>Currency: {{1.0 * inputNumberPipes.value | currency:currency.value:currencyShort.checked:'1.1-2'}}</div>
      <input type="checkbox" #currencyShort checked (change)="0">
      Short currency code
    </section>
